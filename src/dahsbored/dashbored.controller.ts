  ...
  private async handleAllRevenueMetrics(filterQueryDto: FiltersDashboredDto) {
    ...
    return this.createMetrics(
      [
        ...
        ["Deals Deposits Cash", revenueData?.details.dealsDeposites || 0],
        ...
        ["Reservation Room Deposits Cash", revenueData?.details.reservationRoomDeposites || 0],
        ["Packages Cash", revenueData?.details.packagesRevenue || 0],
        ["Packages Deposits Cash", revenueData?.details.packagesDeposites || 0],
        ["Membership Cash", revenueData?.details.membershipRevenue || 0],
        ["Membership Deposits Cash", revenueData?.details.membershipDeposites || 0],
  ...
  private async handleAllRevenueMetricsAllPaymentMethods(filterQueryDto: FiltersDashboredDto) {
    ...
    return this.createMetrics(
      [
        ...
        ["Deals Deposits All Payment Methods", revenueData?.details.dealsDeposites || 0],
        ...
        [
          ...
          revenueData?.details.reservationRoomDeposites || 0,
        ],
        ["Packages All Payment Methods", revenueData?.details.packagesRevenue || 0],
        ["Packages Deposits All Payment Methods", revenueData?.details.packagesDeposites || 0],
        ["Membership All Payment Methods", revenueData?.details.membershipRevenue || 0],
        ["Membership Deposits All Payment Methods", revenueData?.details.membershipDeposites || 0],
  ...
  private async handleAllRevenueMetricsVisa(filterQueryDto: FiltersDashboredDto) {
    ...
    return this.createMetrics(
      [
        ...
        ["Deals Deposits Visa", revenueData?.details.dealsDeposites || 0],
        ...
        ["Reservation Room Deposits Visa", revenueData?.details.reservationRoomDeposites || 0],
        ["Packages Visa", revenueData?.details.packagesRevenue || 0],
        ["Packages Deposits Visa", revenueData?.details.packagesDeposites || 0],
        ["Membership Visa", revenueData?.details.membershipRevenue || 0],
        ["Membership Deposits Visa", revenueData?.details.membershipDeposites || 0],
  ...
  private async handleAllRevenueMetricsInstapay(filterQueryDto: FiltersDashboredDto) {
    ...
    return this.createMetrics(
      [
        ...
        ["Deals Deposits Instapay", revenueData?.details.dealsDeposites || 0],
        ...
        ["Reservation Room Deposits Instapay", revenueData?.details.reservationRoomDeposites || 0],
        ["Packages Instapay", revenueData?.details.packagesRevenue || 0],
        ["Packages Deposits Instapay", revenueData?.details.packagesDeposites || 0],
        ["Membership Instapay", revenueData?.details.membershipRevenue || 0],
        ["Membership Deposits Instapay", revenueData?.details.membershipDeposites || 0],
  ...
  private async handleAllRevenueMetricsVodafone(filterQueryDto: FiltersDashboredDto) {
    ...
    return this.createMetrics(
      [
        ...
        ["Deals Deposits Vodafone Cash", revenueData?.details.dealsDeposites || 0],
        ...
        [
          "Reservation Room Deposits Vodafone Cash",
          revenueData?.details.reservationRoomDeposites || 0,
        ],
        ["Packages Vodafone Cash", revenueData?.details.packagesRevenue || 0],
        ["Packages Deposits Vodafone Cash", revenueData?.details.packagesDeposites || 0],
        ["Membership Vodafone Cash", revenueData?.details.membershipRevenue || 0],
        ["Membership Deposits Vodafone Cash", revenueData?.details.membershipDeposites || 0],
